...
import { Calendar, Clock, Target, Flame, Trophy, Play, CheckCircle, ArrowLeft, Bell, Settings } from "lucide-react"
...
const challenges = [
  {
    ...
    exercises: [
      { day: 1, name: "Warm-up Cardio", details: "50 jumping jacks, 30 high knees, 20 burpees", duration: 15 },
      { day: 2, name: "HIIT Blast", details: "100 high knees, 40 mountain climbers, 30 jump squats", duration: 18 },
      { day: 3, name: "Endurance Builder", details: "60 jumping jacks, 50 high knees, 25 burpees", duration: 20 },
  ...
  },
  {
    ...
    difficulty: "Beginner",
    exercises: [{ day: 1, name: "Core Foundation", details: "30 crunches, 20 leg raises, 30-sec plank", duration: 12 }],
  },
  {
    id: 3,
    ...
    difficulty: "Advanced",
    exercises: [
      { day: 1, name: "Total Body Blast", details: "20 push-ups, 30 squats, 15 burpees, 45-sec plank", duration: 25 },
    ],
  },
]
...
export default function FitnessApp() {
  ...
  // Calculate progress
  const progress = selectedChallenge ? (completedDays.length / selectedChallenge.duration) * 100 : 0
  ...
  const WelcomeScreen = () => (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex flex-col items-center justify-center p-6 text-white relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-20 left-10 text-yellow-300">
      ...
      <div className="absolute top-32 right-16 text-pink-300">✨</div>
      <div className="absolute bottom-32 left-8 text-blue-300">⭐</div>
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-purple-200 text-lg">Join thousands completing 30-day fitness challenges</p>
      </div>
      ...
      <div className="w-full max-w-sm space-y-4">
        ...
        <Button
          variant="outline"
          className="w-full border-white/20 text-white hover:bg-white/10 py-4 rounded-2xl text-lg"
        >
          <span className="mr-2">📱</span>
          Continue with Apple
        </Button>
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-white p-4 rounded-b-3xl shadow-sm">
          <div className="flex items-center justify-between mb-4 pt-4">
            <Button variant="ghost" size="icon" onClick={() => setCurrentScreen("challenges")}>
              <ArrowLeft className="h-6 w-6" />
            </Button>
          ...
          <Card className="mb-4">
            <CardContent className="p-4">
              ...
              {selectedChallenge?.exercises[0] && (
                <div className="mb-4">
                  <h4 className="font-semibold mb-2">{selectedChallenge.exercises[0].name}</h4>
                  <p className="text-gray-600 text-sm mb-3">{selectedChallenge.exercises[0].details}</p>
                  <div className="flex items-center gap-2 text-sm text-gray-600">
                    <Clock className="h-4 w-4" />
                    <span>{selectedChallenge.exercises[0].duration} minutes</span>
                  </div>
                </div>
              )}
              ...
              <div className="flex gap-2">
                ...
                <Button variant="outline" onClick={() => setCurrentScreen("progress")}>
                  <Calendar className="h-4 w-4" />
                </Button>
              </div>
            </CardContent>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Card>
              <CardContent className="p-4 text-center">
                ...
                <Button variant="ghost" size="sm" onClick={() => setCurrentScreen("progress")} className="mt-2">
                  Open
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="mb-6">
              <CardContent className="p-6">
                <div className="text-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold mb-2">{selectedChallenge.exercises[0].name}</h2>
                  <p className="text-gray-600">{selectedChallenge.exercises[0].details}</p>
                </div>

                <div className="space-y-4 mb-6">
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <span>Duration</span>
                    <span className="font-semibold">{selectedChallenge.exercises[0].duration} minutes</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <div className="space-y-3">
                  <Button
                    onClick={() => {
                      ...
                      setCurrentDay((prev) => Math.min(prev + 1, selectedChallenge?.duration || 30))
                      setCurrentScreen("dashboard")
                    }}
                  ...
                  <Button variant="outline" className="w-full" onClick={() => setCurrentScreen("dashboard")}>
                    Skip for Today
                  </Button>
                </div>
              </CardContent>
          ...
          <div className="bg-white p-4 rounded-b-3xl shadow-sm">
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              <div className="text-center">
                <div className="text-2xl font-bold text-purple-600">{completedDays.length}</div>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="grid grid-cols-7 gap-2">
                  {Array.from({ length: selectedChallenge?.duration || 30 }, (_, i) => i + 1).map((day) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          status === "current" && "bg-purple-500 text-white ring-2 ring-purple-300",
                          status === "missed" && "bg-red-100 text-red-600",
                          status === "upcoming" && "bg-gray-100 text-gray-400",
                        )}
                      >
                        {status === "completed" ? <CheckCircle className="h-4 w-4" /> : day}
                      </button>
                    )
                  })}
                </div>
